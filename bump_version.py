...
# --- File Paths ---
INIT_PATH = Path("another_sender/__init__.py")
...
def git_commit_and_tag(version):
    try:
        subprocess.run(["git", "add", str(INIT_PATH), str(CHANGELOG_PATH), str(PYPROJECT_PATH)], check=True)
...
def main():
    print("🛠️  another-sender Version Bump Utility")
